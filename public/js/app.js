...
/* harmony import */ var _vendor_app_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/app.js */ "./resources/js/vendor/app.js");
/* harmony import */ var _routes_Auth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./routes/Auth */ "./resources/js/routes/Auth.js");
/* harmony import */ var _routes_Events__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./routes/Events */ "./resources/js/routes/Events.js");
/*======================================================================================
*
*
*    Application
...
new _vendor_app_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
  on: {
  ...
  routes: {
    '/login': _routes_Auth__WEBPACK_IMPORTED_MODULE_2__["default"].login,
    '/signup': _routes_Auth__WEBPACK_IMPORTED_MODULE_2__["default"].signup,
    '/create': _routes_Events__WEBPACK_IMPORTED_MODULE_3__["default"].create
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ((function (w, d) {
  function Navigation() {
    this.$nav = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav');
...
/***/ "./resources/js/controllers/EventCreate.js":
/*!*************************************************!*\
  !*** ./resources/js/controllers/EventCreate.js ***!
  \*************************************************/
/*! exports provided: default */
...
/* harmony import */ var air_datepicker_dist_js_i18n_datepicker_en__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! air-datepicker/dist/js/i18n/datepicker.en */ "./node_modules/air-datepicker/dist/js/i18n/datepicker.en.js");
/* harmony import */ var air_datepicker_dist_js_i18n_datepicker_en__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(air_datepicker_dist_js_i18n_datepicker_en__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony default export */ __webpack_exports__["default"] = ((function (w, d, $) {
  ...
  EventCreate.prototype.setup = function () {
    ...
    this.$start.datepicker({
      dateFormat: ' ',
      // Do not show date on input
      timepicker: true,
      timeFormat: 'hh:ii',
      classes: 'only-timepicker',
      // this class hides calendar
      minutesStep: 10,
    ...
    autosize__WEBPACK_IMPORTED_MODULE_2___default()(this.textarea); // Init label autocomplete
    ...
    })[0].selectize; // Fix height problem

    this.selectize.close(); // Submit form on click "submit" button
  ...
  EventCreate.prototype.renderSelectizeOption = function (item, escape) {
    return ['<div class="flex w-full items-center px-2 py-2">', '<span>' + escape(item.text) + '</span>', '<i class="w-1/4 h-3 ml-auto rounded" style="background-color: ' + item.color + '"></i>', '</div>'].join('');
  };

  EventCreate.prototype.renderSelectizeItem = function (item, escape) {
    return ['<div class="flex w-full items-center pr-10">', '<span>' + escape(item.text) + '</span>', '<i class="w-1/4 h-3 ml-auto rounded" style="background-color: ' + item.color + '"></i>', '</div>'].join('');
  };
...
/***/ "./resources/js/controllers/Signup.js":
/*!********************************************!*\
  !*** ./resources/js/controllers/Signup.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(jQuery) {/* harmony import */ var _vendor_ImageReader_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../vendor/ImageReader.js */ "./resources/js/vendor/ImageReader.js");
/*======================================================================================
*
*
*    Sign up Controller
...
/* harmony default export */ __webpack_exports__["default"] = ((function (w, d, $) {
  ...
  Signup.prototype.setup = function () {
    /* Init image reader */
    new _vendor_ImageReader_js__WEBPACK_IMPORTED_MODULE_0__["default"](this.avatar);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _controllers_Signup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../controllers/Signup */ "./resources/js/controllers/Signup.js");
/*======================================================================================
*
*
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  signup: function signup() {
    return new _controllers_Signup__WEBPACK_IMPORTED_MODULE_0__["default"]();
  }
});

/***/ }),

/***/ "./resources/js/routes/Events.js":
/*!***************************************!*\
  !*** ./resources/js/routes/Events.js ***!
  \***************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _controllers_EventCreate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../controllers/EventCreate */ "./resources/js/controllers/EventCreate.js");
/*======================================================================================
*
*
*    Events routes
...
/* harmony default export */ __webpack_exports__["default"] = ({
  create: function create() {
    return new _controllers_EventCreate__WEBPACK_IMPORTED_MODULE_0__["default"]();
  }
});

/***/ }),

/***/ "./resources/js/vendor/ImageReader.js":
/*!********************************************!*\
  !*** ./resources/js/vendor/ImageReader.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vendor_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../vendor/_.js */ "./resources/js/vendor/_.js");
/*======================================================================================
*
*
*    Image Uploader
...
var ImageReader = function (w, d, _) {
  ...
  return ImageReader;
}(window, document, _vendor_js__WEBPACK_IMPORTED_MODULE_0__["default"]);

/* harmony default export */ __webpack_exports__["default"] = (ImageReader);

/***/ }),

/***/ "./resources/js/vendor/_.js":
/*!**********************************!*\
  !*** ./resources/js/vendor/_.js ***!
  \**********************************/
/*! exports provided: default */
...
var _ = function () {
  var CHARS = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",
    ...
    return {
      ...
      parent: function parent(el, classname) {
        while (el) {
          if (!el) {
            return null;
          }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_.js */ "./resources/js/vendor/_.js");
/* harmony import */ var _events_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./events.js */ "./resources/js/vendor/events.js");
/* harmony import */ var _router_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./router.js */ "./resources/js/vendor/router.js");
/*======================================================================================
*
*
*    Application
...
var token,
  ...
  function App(options) {
    this.setup(options);
    $(d).ajaxError(this.on.ajaxError).ajaxComplete(this.on.ajaxComplete).ready(this.init.bind(this));
  }

  App.prototype.setup = function (options) {
    this.options = _js__WEBPACK_IMPORTED_MODULE_0__["default"].extend({
      prefix: '/',
      routes: {},
      headers: {},
      on: {}
    }, options);
    this.on = _js__WEBPACK_IMPORTED_MODULE_0__["default"].extend({
      ready: null,
      ajaxError: null,
      ajaxComplete: null
    }, this.options.on);
    ...
    this.router = new _router_js__WEBPACK_IMPORTED_MODULE_2__["default"](this.options);
  };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_.js */ "./resources/js/vendor/_.js");
...
__webpack_require__(/*! E:\xampp\htdocs\TODOS\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! E:\xampp\htdocs\TODOS\resources\sass\app.scss */"./resources/sass/app.scss");
